...
Page({
    ...
    payGo:function(e){
      ...
      wx.navigateTo({
        url: '/pages/order/create/index?id=' + e.currentTarget.dataset.id + '&option_stock_id=' + e.currentTarget.dataset.option_stock_id + '&stock_time=' + e.currentTarget.dataset.stock_time + '&check_in_time=' + e.currentTarget.dataset.check_in_time + "&check_out_time=" + e.currentTarget.dataset.check_out_time + '&idd=' + e.currentTarget.dataset.idd
      })
    },
    checkall: function(t) {
        e.loading();
