...
module.exports = {
  ...
  buyNow: function (option_stock_id,stock_time, idd,t, d, i) {
    console.log(option_stock_id)
    ...
    if(idd==1){
      ...
      if (n && n.fields.length > 0) {
        ...
        console.log(n.f_data), a.post("order/create/diyform", {
          ...
          0 == d.data.goods.isgift || "goods_detail" != i ? wx.redirectTo({
            url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&gdid=" + t.gdid + "&selectDate=" + c + '&option_stock_id=' + option_stock_id + '&stock_time=' + stock_time + '&idd=' + idd 
          }) : "" != l || 1 == d.data.goods.gifts.length ? (1 == d.data.goods.gifts.length && (l = d.data.goods.gifts[0].id),
            wx.redirectTo({
              url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&gdid=" + t.gdid + "&giftid=" + l + '&option_stock_id=' + option_stock_id + '&stock_time=' + stock_time + '&idd=' + idd 
            })) : o.toast(d, "请选择赠品");
        });
      } else 0 == d.data.goods.isgift || "goods_detail" != i ? wx.navigateTo({
        url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&selectDate=" + c + '&option_stock_id=' + option_stock_id + '&stock_time=' + stock_time + '&idd=' + idd 
      }) : "" != l || 1 == d.data.goods.gifts.length ? (1 == d.data.goods.gifts.length && (l = d.data.goods.gifts[0].id),
        wx.navigateTo({
          url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&giftid=" + l + '&option_stock_id=' + option_stock_id + '&stock_time=' + stock_time + '&idd=' + idd 
        })) : o.toast(d, "请选择赠品");
    } if (idd == 2){
      var s = d.data.optionid, r = d.data.goods.hasoption, n = d.data.diyform, l = d.data.giftid;
      if (9 == d.data.goods.type) var c = d.data.checkedDate / 1e3;
      ...
      if (n && n.fields.length > 0) {
        ...
        console.log(n.f_data), a.post("order/create/diyform", {
          ...
          0 == d.data.goods.isgift || "goods_detail" != i ? wx.redirectTo({
            url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&gdid=" + t.gdid + "&selectDate=" + c+ '&idd=' + idd + '&check_in_time=' + stock_time + '&check_out_time=' + option_stock_id
          }) : "" != l || 1 == d.data.goods.gifts.length ? (1 == d.data.goods.gifts.length && (l = d.data.goods.gifts[0].id),
            wx.redirectTo({
              url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&gdid=" + t.gdid + "&giftid=" + lidd + '&check_in_time=' + stock_time + '&check_out_time=' + option_stock_id
            })) : o.toast(d, "请选择赠品");
        });
      } else 0 == d.data.goods.isgift || "goods_detail" != i ? wx.navigateTo({
        url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&selectDate=" + c +'&idd=' + idd + '&check_in_time=' + stock_time + '&check_out_time=' + option_stock_id
      }) : "" != l || 1 == d.data.goods.gifts.length ? (1 == d.data.goods.gifts.length && (l = d.data.goods.gifts[0].id),
        wx.navigateTo({
          url: "/pages/order/create/index?id=" + d.data.id + "&total=" + d.data.total + "&optionid=" + s + "&giftid=" + l +  '&idd=' + idd + '&check_in_time=' + stock_time + '&check_out_time=' + option_stock_id
        })) : o.toast(d, "请选择赠品");
    }else{
      var s = d.data.optionid, r = d.data.goods.hasoption, n = d.data.diyform, l = d.data.giftid;
      if (9 == d.data.goods.type) var c = d.data.checkedDate / 1e3;
    ...
    getCart: function(t, d) {
      console.log(d)
      console.log(d.data.option_stock_id)
      console.log(d.data.stock_time)
        ...
        if (s > 0 && !i) o.toast(d, "请选择规格"); else if (d.data.quickbuy) {
            ...
            total: d.data.total,
            optionid: i,
          option_stock_id: d.data.option_stock_id,
          stock_time: d.data.stock_time,
          check_in_time: d.data.ops,
          check_out_time: d.data.op
        }, function(t) {
            if (0 == t.error) {
                o.toast(d, "添加成功");
                var a = d.data.goods;
